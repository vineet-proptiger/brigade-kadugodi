...
const units = [
  ...
  },
  {
    ...
    btnText: "Get Details",
    features: [
      "Super Built-up: 1200-1300 Sq.ft",
      "Premium Specifications",
      "Luxury Finishes",
    ],
  },
  {
    type: "3 BHK",
    size: "2100 - 2200 Sq.ft",
    price: "Ask For Price",
    oldPrice: null,
    btnText: "Get Details",
    features: [
      "Super Built-up: 2100 - 2200 Sq.ft",
      "Premium Specifications",
      "Luxury Finishes",
    ],
  },
  {
    ...
    btnText: "Get Details",
    features: [
      "Super Built-up: 2500 - 2800 Sq.ft",
      "Premium Specifications",
      "Luxury Finishes",
    ],
  },
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div 
          className="relative bg-white border border-[#D5C2A8] max-w-[1200px] w-full mx-auto overflow-hidden"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          <CurvedCorners />

          {/* Grid Container for 4 Units */}
          <div className="grid grid-cols-1 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-[#D5C2A8]">
            {units.map((unit, idx) => (
              <div key={idx} className="p-6 xl:p-8 relative flex flex-col justify-between">
                <div>
                  {/* Title & Size */}
                  <h3
                  ...
                  <div className="mb-8" data-aos={idx % 2 === 0 ? "flip-right" : "flip-left"} data-aos-delay="500">
                    ...
                    <div className="flex items-baseline gap-3">
                      ...
                      <p className="text-2xl xl:text-3xl font-extrabold whitespace-nowrap tracking-tight" style={{ fontFamily: F_SANS, color: GOLD }}>
                        {unit.price}
                      </p>
                    </div>
                  </div>
