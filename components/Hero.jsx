      ...
      <div className="hero-slider-wrapper grid md:hidden">
        <div className="slide-layer active" style={{ gridArea: '1 / 1 / 2 / 2' }}>
          <Image
            ...
            alt="Brigade Kadugodi Mobile Banner"
            width={768}
            height={800}
            className="hero-image"
            priority={true}
      ...
      <div className="hero-content">
        <>
            ...
            <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                '40+ Acres Integrated Township',
                '53 Floor Residences Towers',
                '400 Keys Hotel and retail space',
                '35 Floors Commercial space'
              ].map((text, i) => (
            ...
            {/* Restored Subtitle */}
            <p className="hero-price-line" data-aos="fade-up" data-aos-delay="1300" style={{ marginBottom: '0px', fontSize: 'clamp(16px, 2vw, 24px)', fontWeight: 'bold' }}>
              1, 2, 3 & 4 BHK Homes
            </p>
            ...
            <div className="hero-cta-row" style={{ marginTop: '16px' }}>
              ...
              <div data-aos="flip-up" data-aos-delay="1400">
                ...
                >
                  Starting Price : <span className="hero-price-amt" style={{ fontSize: '15px', marginLeft: '6px' }}>₹ 1 Cr*</span>
                </div>
              </div>
