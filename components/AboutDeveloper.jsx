          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                <TypewriterText text="Brigade Group is one of India's leading real estate developers, established in 1986 and headquartered in Bangalore. Over the past three decades, the company has built a strong presence across residential, commercial, retail, hospitality, and education sectors in key cities such as Bangalore, Chennai, Hyderabad, Kochi, and Mysore. Known for its commitment to quality construction, timely delivery, and customer satisfaction, Brigade has consistently delivered projects that combine practical design with modern features. Each development reflects careful planning, attention to detail, and the use of high-quality materials, ensuring homes and commercial spaces that are both functional and visually appealing." />
              </p>
            </div>
