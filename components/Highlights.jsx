...
const highlights = [
  { title: 'PREMIUM PROJECT', desc: 'Premium residential project by Brigade Group', Icon: IconBuilding },
  { title: 'STRATEGIC LOCATION', desc: 'Located on Whitefield – Budigere cross', Icon: IconHome },
  { title: '40 ACRES OF LAND', desc: 'Sprawled across 40 acres of prime land', Icon: IconTrees },
  { title: 'LUXURY APARTMENTS', desc: 'Features 2,000 luxury high-rise apartments', Icon: IconMountain },
  { title: 'IT HUBS CONNECTIVITY', desc: 'Close to Whitefield, Varthur & Sarjapur Road IT hubs', Icon: IconSmart },
  { title: 'AIRPORT PROXIMITY', desc: 'Approx. 45 minutes from Kempegowda International Airport', Icon: IconSunCloud },
]
